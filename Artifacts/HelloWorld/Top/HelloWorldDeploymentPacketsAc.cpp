...
namespace HelloWorldDeployment {
  ...
  const Svc::TlmPacketizerPacketList HelloWorldDeploymentPacketsPkts = {
      {
         &CDH,
         &CDHErrors,
         &DriveTlm,
  ...
  static const Svc::TlmPacketizerChannelEntry ignoreList[] = {
      ...
      {3840, 0}, // helloWorld.GreetingCount
  };

  const Svc::TlmPacketizerPacket HelloWorldDeploymentPacketsIgnore = { ignoreList, 0, 0, FW_NUM_ARRAY_ELEMENTS(ignoreList) };

} // end namespace HelloWorldDeployment
