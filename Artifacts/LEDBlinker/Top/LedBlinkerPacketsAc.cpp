...
namespace LedBlinker {
  ...
  static const Svc::TlmPacketizerChannelEntry LedChannelsList[] = {
      {3585, 8}, // led.LedTransitions
      {3584, 4}, // led.BlinkingState
  };
  ...
  const Svc::TlmPacketizerPacketList LedBlinkerPacketsPkts = {
      {
         &CDH,
         &CDHErrors,
         &DriveTlm,
  ...
  const Svc::TlmPacketizerPacket LedBlinkerPacketsIgnore = { ignoreList, 0, 0, FW_NUM_ARRAY_ELEMENTS(ignoreList) };
