// ======================================================================
// \title  HelloWorldDeploymentTopologyAc.cpp
// \author Generated by fpp-to-cpp
// \brief  cpp file for HelloWorldDeployment topology
// ======================================================================
...
namespace HelloWorldDeployment {
  ...
  Components::HelloWorld helloWorld(FW_OPTIONAL_NAME("helloWorld"));
  ...
  void initComponents(const TopologyState& state) {
    ...
    helloWorld.init(QueueSizes::helloWorld, InstanceIds::helloWorld);
  ...
  void setBaseIds() {
    ...
    helloWorld.setIdBase(BaseIds::helloWorld);
  ...
  void connectComponents() {
    ...
    cmdDisp.set_compCmdSend_OutputPort(
        6,
        helloWorld.get_cmdIn_InputPort(0)
    );
    cmdDisp.set_compCmdSend_OutputPort(
        7,
    ...
    helloWorld.set_cmdRegOut_OutputPort(
        0,
    ...
    helloWorld.set_cmdResponseOut_OutputPort(
        0,
        cmdDisp.get_compCmdStat_InputPort(0)
    );
    ...
    helloWorld.set_logOut_OutputPort(
        0,
        eventLogger.get_LogRecv_InputPort(0)
    );
    ...
    // Parameters
    helloWorld.set_prmGetOut_OutputPort(
        0,
        prmDb.get_getPrm_InputPort(0)
    );
    helloWorld.set_prmSetOut_OutputPort(
        0,
    ...
    helloWorld.set_tlmOut_OutputPort(
        0,
        tlmSend.get_TlmRecv_InputPort(0)
    );
    ...
    helloWorld.set_logTextOut_OutputPort(
        0,
        textLogger.get_TextLogger_InputPort(0)
    );
    ...
    helloWorld.set_timeCaller_OutputPort(
        0,
        linuxTime.get_timeGetPort_InputPort(0)
    );
  ...
  void startTasks(const TopologyState& state) {
    ...
    helloWorld.start(
      static_cast<NATIVE_UINT_TYPE>(Priorities::helloWorld),
      static_cast<NATIVE_UINT_TYPE>(StackSizes::helloWorld),
      Os::Task::TASK_DEFAULT, // Default CPU
      static_cast<NATIVE_UINT_TYPE>(TaskIds::helloWorld)
    );
    prmDb.start(
  ...
  void freeThreads(const TopologyState& state) {
    ...
    (void) helloWorld.ActiveComponentBase::join(nullptr);
